...
class App extends React.Component {
  ...
  fetchFolders(){
    ...
    fetch('https://todo-with-spring.herokuapp.com/api/folder-list/')
  ...
  handleSubmit(e){
    ...
    var url = 'https://todo-with-spring.herokuapp.com/api/folder-create/';
  ...
  handleTaskSubmit(e){
    e.preventDefault();
    var url = `https://todo-with-spring.herokuapp.com/api/folder/${this.state.activeFolder.id}/task-update/${this.state.activeItem.id}/`;
    if (this.state.editing === false){
      var url = `https://todo-with-spring.herokuapp.com/api/folder/${this.state.activeFolder.id}/task-create/`
    }
  ...
  fetchTasks(f_id){
    ...
    fetch(`https://todo-with-spring.herokuapp.com/api/folder/${global.activeFolderVar.id}/task-list/`)
    .then(response => response.json())
    .then(data =>
      this.setState({
        taskList: data,
  ...
  removeFolder(folder){
    ...
    var url = `https://todo-with-spring.herokuapp.com/api/folder-delete/${folder.id}/`
  ...
  markUnmark(task){
    ...
    var url = `https://todo-with-spring.herokuapp.com/api/folder/${this.state.activeFolder.id}/task-update/${task.id}/m-u/`
    fetch(url, {
      method:'POST',
      headers:{
        "Accept": 'application/json',
  ...
  removeTask(task){
    ...
    var url = `https://todo-with-spring.herokuapp.com/api/folder/${global.activeFolderVar.id}/task-delete/${task.id}/`
  ...
  render(){
    ...
    if (this.state.viewingItems === false){
      ...
      appTitle = this.state.activeItem.title
      return (
        <div id="container" className="container">
            <br></br>
